...
public class TC3_LoginPage {
	...
	static {
		...
		PageFactory.initElements(driver, TC3_LoginPage.class);
	}
	
	public TC3_LoginPage (WebDriver driver) {
	    this.driver = driver;
	...
	@CacheLookup
	WebElement TxtforEmployeeName;
	
	public void setTxtforEmployeeName(String EmployeeName) {
		TxtforEmployeeName.clear();
		TxtforEmployeeName.sendKeys(EmployeeName);
	}

	public boolean getTxtforEmployeeName() {
		return TxtforEmployeeName.isDisplayed();
	}
